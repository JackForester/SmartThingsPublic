 ...
 *	Version 1.1
 *  Date: 2019.06.07
 *	Author: Jack Forester
 *  Copyright 2019 Jack Forester
 *
 ...
 *		This handler supports all features of the device (both normal and 4 Dimmer operating modes).
 * |-----------------------------------------------------------------------------------------------------------------------------------------------|
 *
 *
 *	TO-DO:
 ...
 */
metadata {
	definition (name: "Qubino RGBW Dimmer New", namespace: "JackForester", author: "Jack Forester") {
		capability "Actuator"
		capability "Switch"
